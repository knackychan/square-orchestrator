...
| `2026-08-09-fork-agent-orchestrator/square-session-first-implementation-pack/plans/tasks/SA00-T03.md`, `2026-08-09-fork-agent-orchestrator/square-session-first-implementation-pack/plans/SA00-T03-BUILD.md`, `2026-08-09-fork-agent-orchestrator/square-session-first-implementation-pack/plans/SA00-T03-TASKS.md`, `2026-08-09-fork-agent-orchestrator/square-session-first-implementation-pack/plans/KICKOFF_PROMPT_SA00-T03.md` | Owner-activated SA00-T03 design/inventory packet, build guide, ordered task list, and kickoff prompt |
