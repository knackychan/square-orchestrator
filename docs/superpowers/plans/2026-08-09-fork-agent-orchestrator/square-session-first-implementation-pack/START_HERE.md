...
13. `plans/tasks/SA00-T01.md`
14. `plans/KICKOFF_PROMPT_SA00-T01.md`
...
After reviewing and completing SA00-T01, dispatch SA00-T02. The baseline helper is:
...
`-ContinueOnFailure` is appropriate for the unchanged baseline because pre-existing failures must be captured rather than hidden. The A0 review decides whether each finding is acceptable, repairable, or blocking.
...
Do not dispatch SA00-T02 until the SA00-T01 completion receipt has been reviewed.
