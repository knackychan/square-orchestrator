...
Do not claim **SA00-T02 — Capture the unchanged Windows build/test/package baseline** accepted. Owner acceptance must be recorded separately in canonical status authority before **SA00-T03 — License, attribution, identity, telemetry, updater, and data isolation design** can start.
```
